...
<body>
	...
	<form action="/admin/userStore" method="post">
		...
		<div class="wrapper">
			...
			<input type="text" name="username" style="background-color: white" id="" placeholder="">

			<label for="email" class="font">E-Mail</label>
			<input type="text" name="email" style="background-color: white" id="" placeholder="">

			<label for="pass" class="font">Password</label>
			<input type="password" name="pass" style="background-color: white" id="" placeholder="">

			<div class="popup" onclick="myFunction()">
				<button style="background-color: #2874A6; color: white; width: 100%; height: 100%;">Register</button>
				<span class="popuptext" id="myPopup">User Terdaftarkan</span>
			</div>
		</div>
	</form>
