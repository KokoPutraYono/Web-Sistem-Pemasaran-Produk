  ...
  <div class="container">
    <table>
      ...
      <tr>
        ...
        <td>{{ $w->nama_produk }}</td>
        <td>{{ $w->wilayah }}</td>
        <td class="ehd"><a href="/admin/wilayahEdit/{{ $w->id }}" class="ehl"><i class="fa-solid fa-pen"></i></a></td>
        <td class="ehd"><a href="/admin/wilayahHapus/{{ $w->id }}" class="ehl" onclick="fHapus()"><i class="fa-solid fa-trash"></i></a></td>
      @endforeach
    </table>
